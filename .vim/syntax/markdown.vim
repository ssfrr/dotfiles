...
syn cluster markdownBlock contains=markdownTitle,markdownH1,markdownH2,markdownH3,markdownH4,markdownH5,markdownH6,markdownBlockquote,markdownListMarker,markdownOrderedListMarker,markdownCodeBlock,markdownRule
...
syn region markdownTitle matchgroup=markdownHeadingDelimiter start="%#\@!"   end="#*\s*$" keepend oneline contains=@markdownInline contained
...
syn region markdownItalic start="\k\@<!_\S\@=" end="\S\@<=_\k\@!" keepend contains=markdownLineStart
...
hi def link markdownTitle                 htmlH1
